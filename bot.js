...
client.on('ready', () => { //playing
    client.user.setGame(`Xhelp | Servers : ${client.guilds.size}	`,'https://www.twitch.tv/faresgameryt');
    client.user.setStatus('Online')
});

client.on('message', message => {//invite
     if (message.content === "Xinvite") {
     let embed = new Discord.RichEmbed()
.setColor("RANDOM")
...
client.on('message', message => {
    if (message.content === 'Xhelp') {
        ...
        .addField('Xinvite', 'لدعوة البوت لسيرفرك')
        .addField('Xplay', 'لتشغيل اغنية')
        .addField('Xjoin', 'دخول رومك الصوتي')
        .addField('Xvol ( 0 - 150 )', 'تغيير صوت البوت')
